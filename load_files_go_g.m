function array = load_files_go_g(am_ascii,dist)
...
if dist == 0
    filename = ['E:\Diamond19\processing\DK_GI\curv_ia\gauss_go\',am_ascii];
else
    filename = ['E:\Diamond19\processing\DK_GI\curv_ia\gauss_dist_go\',am_ascii];
end
delimiter = ',';
startRow = start;
