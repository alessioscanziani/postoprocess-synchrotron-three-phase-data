function array = load_files_gw_g(am_ascii,dist)
...
if dist == 0
    filename = ['E:\Diamond19\processing\DK_GI\curv_ia\gauss_gw\',am_ascii];
else
    filename = ['E:\Diamond19\processing\DK_GI\curv_ia\gauss_dist_gw\',am_ascii];
end
delimiter = ',';
startRow = start;
